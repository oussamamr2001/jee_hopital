...
public class StudentsApplication implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        productRepository.save(new Product(null,"Sam",2300,4));
        productRepository.save(new Product(null,"Computer",7800,2));
        productRepository.save(new Product(null,"Printer",9000,1));
